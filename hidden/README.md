...
- [Try the demo](https://sourabh-study.github.io/projects/hidden-bookmarks/#demo)
...
Almost a year ago, I created [Link Lock](https://sourabh-study.github.io/link-lock)
...
- [A stable, simplified version integrated directly into Link
  Lock](https://sourabh-study.github.io/link-lock/hidden/)
- [An experimental
  version](https://sourabh-study.github.io/projects/hidden-bookmarks/#demo), designed
...
Lock](https://sourabh-study.github.io/link-lock/).
...
form](https://sourabh-study.github.io/about#contact).
...
- Despite spending hours revising the instructions for the [Link Lock hidden
  bookmarks](https://sourabh-study.github.io/link-lock/hidden/) page, it is still far
